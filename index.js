...
function removeFlavorByName(array,forgottenFlavor){
  let index = array.indexOf(forgottenFlavor)
...
function filterByWord(allFlavors,searchQuery,){
  let newArray=[];
  for(let i=0; i<=allFlavors.length-1; i++){
    if(allFlavors[i].includes(searchQuery)){
...
function getAverageWordLength(decoy){
  let myTest = 2
  return myTest
